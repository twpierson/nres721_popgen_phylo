...
<div class="alert alert-info">
  <strong>Discussion:</strong> This suggests that we have 396 "character site patterns". What does that mean? Why is this number smaller than the number of loci we have?
</div>
...
Now, we'll conduct the discriminant analysis. Because we have a small number of PCs and clusters, we'll retain all of them here (i.e., enter "11" for `n.pca` and "4" for `n.da`).
```{r}
set.seed(1234)
